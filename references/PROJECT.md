...
- **Colour system, remaining rollout (2026-08-30)** — OG card palette per register (`lib/og/palette.ts` mirrors are still purple), `lib/email.ts` link colour, "goal reached" said in words on fundraiser pages (green on green). (Print pack, keepsake paper and the wizard wearing the register as it is chosen: done 2026-08-31; prototype #584 closed.)
