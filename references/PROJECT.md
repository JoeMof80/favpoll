...
topics (
  ...
  is_active boolean not null default true,
  placeholders jsonb default '{}',  -- Keyed by register: { remembering, celebrating_one, celebrating_many, cause, neutral }. Each entry: { pronouns, about, reveal }.
