...
export const OCCASION_PLACEHOLDERS: Record<string, OccasionPlaceholders> = {
  ...
  birthday: {
    ...
    reveal: "e.g. Sarah's is the Bourbon. She once ate four packets in one sitting.",
  },
  retirement: {
    name: "David Clarke",
    ...
    reveal: "e.g. David's was the Dordogne. He kept a photo of it on his desk for thirty years.",
  },
  wedding: {
    name: "Emma & James",
    ...
    reveal: "e.g. Theirs was Italian. They've been arguing about the best pizza in Naples since 2019.",
  },
  engagement: {
    name: "Zara & Ben",
    bio: "Ben proposed at the top of Arthur's Seat on New Year's Day. Zara said yes before he'd finished the question…",
    framing: "e.g. Zara & Ben have a song that's entirely theirs — what's yours?",
    reveal: "e.g. Theirs was Perfect. It played when they weren't trying to be romantic, and that was the point.",
  },
  anniversary: {
    name: "Mum & Dad",
    ...
    reveal: "e.g. Theirs was a pot of tea and a good biscuit. Same time every morning for forty years.",
  },
  leaving: {
    name: "Priya Sharma",
  ...
  graduation: {
    ...
    reveal: "e.g. Tom's was Spirited Away. He said it reminded him why things worth doing take time.",
  },
  christening: {
    name: "Lily Rose",
  ...
  achievement: {
    ...
    reveal: "e.g. Marcus's was Mr. Brightside. Apparently it got him through mile 18.",
  },
  recovery: {
    ...
    reveal: "e.g. Claire's was Vienna by Ultravox. She played it on repeat for months.",
  },
  award: {
    ...
    reveal: "e.g. Dr. Grant's was The Lion, the Witch and the Wardrobe. She said it taught her how to teach.",
  },
  promotion: {
    name: "Kwame Asante",
  ...
  celebration: {
    ...
    reveal: "e.g. Theirs was something they never tired of. Ask them about it some time.",
  },
  other: {
    name: "The guest of honour",
    bio: "Tell their story — who they are, what makes them worth celebrating, why people are gathering…",
 ...
 */
export const TOPIC_REVEAL_PLACEHOLDERS: Record<string, { framing: string; reveal: string }> = {
  Colour: {
    framing: "e.g. Belinda had a colour she returned to all her life — what's yours?",
    reveal: "e.g. Belinda's was purple. She wore it to every important occasion.",
  },
  Season: {
    ...
    reveal: "e.g. {name}'s was autumn. She said it always felt like coming home.",
  },
  Film: {
  ...
  Song: {
    ...
    reveal: "e.g. {name}'s was Waterloo Sunset. She said it made London feel beautiful.",
  },
  Flower: {
    framing: "e.g. {name} had a flower she never tired of — what's yours?",
    reveal: "e.g. {name}'s was lavender. She grew it in every garden she ever had.",
  },
  Animal: {
    framing: "e.g. {name} felt closest to one animal above all others — which is yours?",
    reveal: "e.g. {name}'s was the robin. She said they were the bravest small thing.",
  },
  "Comfort food": {
    framing: "e.g. There was a meal {name} always came back to — what's yours?",
    reveal: "e.g. {name}'s was beans on toast. She said nothing else did the job.",
  },
  Drink: {
    framing: "e.g. {name} had a drink that was entirely her own — what's yours?",
    reveal: "e.g. {name}'s was tea. Builders brew, milk no sugar, never negotiable.",
  },
  "Way to spend Sunday": {
    framing: "e.g. {name} had a perfect Sunday — what does yours look like?",
    reveal: "e.g. {name}'s was a long walk followed by a roast. Every week without fail.",
  },
  Biscuit: {
    framing: "e.g. {name} had strong opinions about biscuits — what's your favourite?",
    reveal: "e.g. {name}'s was the Bourbon. She once ate four packets in one sitting.",
  },
}
