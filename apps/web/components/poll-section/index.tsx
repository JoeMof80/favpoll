  ...
  return (
    ...
    >
      ...
      {entitled ? (
        ...
        /* Pre-pledge: blurred decoy with centered unlock overlay. The
           decoy is HEIGHT-CAPPED with a fade-out (founder goal,
           2026-08-02: the locked block must keep formation with the
           stuck header — sticky pinning needed scroll runway that
           mobile lacks and desktop clipped, so the block is instead
           made short enough that there is nothing to scroll apart). */
        <div className="relative">
          ...
          <div
            ...
            aria-hidden="true"
          >
            <div className="max-h-[26rem] space-y-4 [mask-image:linear-gradient(to_bottom,black_70%,transparent)] opacity-60 blur-xs select-none">
