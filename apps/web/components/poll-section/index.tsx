...
export function PollSection({
  ...
  return (
    ...
    >
      ...
      <div className="sticky top-[7rem] z-20 md:top-[var(--hero-stuck-bottom,13.75rem)]">
        ...
        <>
          ...
          {hasItems && (
            <>
              ...
              <div className="sticky top-[calc(7rem+3rem)] z-10 mt-12 flex items-center justify-end gap-2 md:top-[calc(var(--hero-stuck-bottom,13.75rem)+3rem)]">
        ...
        <div className="grid">
          ...
          {onOpenPledgeDialog && (
            ...
            <div className="pointer-events-none z-10 flex flex-col items-center pt-4 [grid-area:1/1]">
              <span className="sticky top-[calc(7rem+4.25rem)] flex w-full flex-col items-center md:top-[calc(var(--hero-stuck-bottom,13.75rem)+4.25rem)]">
                <Button
                  type="button"
                  variant="ghost"
                  onClick={onOpenPledgeDialog}
