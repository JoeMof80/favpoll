        ...
        <>
          ...
          {hasItems && (
            <>
              ...
              <div className="sticky top-[calc(var(--hero-stuck-bottom,10rem)+3rem)] z-10 mt-12 flex items-center justify-end gap-2 md:top-[calc(var(--hero-stuck-bottom,13.75rem)+3rem)]">
