    ...
    <div className="space-y-4 rounded-lg border border-border bg-card px-5 py-4">
      ...
      <div className="flex flex-col items-center gap-2">
        <Button
          ...
          className="w-full"
          onClick={() =>
            window.alert("Publish this event to start receiving pledges.")
          }
        >
          Pledge favourites
        </Button>
...
function LivePledgeCard(props: LiveProps) {
  const {
    pledgeAmount,
    topUpAmount,
    guestEmail,
