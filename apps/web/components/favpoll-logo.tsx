// The mark's geometry, shared with the Open Graph card renderer
// (lib/og/cards.tsx): Satori cannot render a React component that relies on
// Tailwind classes, so it draws the same paths with inline styles. One
// source for the shape keeps the two from drifting.
export const FAVPOLL_MARK_VIEWBOX = "0 0 24 22"
