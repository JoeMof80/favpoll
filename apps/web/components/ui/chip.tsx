...
function Chip({ selected = false, readOnly = false, size = "md", className, ...props }: ChipProps) {
  return (
    <Button
      type="button"
      ...
      className={cn(
        ...
        readOnly
          ? "border-border bg-background font-normal text-muted-foreground/60 shadow-none pointer-events-none"
          : selected
