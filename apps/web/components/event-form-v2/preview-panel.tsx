...
const PENCIL_ICON =
  "absolute top-0 right-0 h-6 w-6 rounded-full border border-border bg-background p-1.5 text-muted-foreground shadow-sm opacity-30 transition-opacity group-hover:opacity-100 group-focus-visible:opacity-100"
      ...
      <div className="grid gap-10 lg:grid-cols-[1fr_300px]">
            ...
            <div className="flex items-start gap-4 md:gap-6">
              ...
              {subject !== "cause" && (
                ...
                >
                  ...
                  />
                  <Pencil
                    className="absolute -top-1 -right-1 h-6 w-6 rounded-full border border-border bg-background p-1.5 text-muted-foreground opacity-30 shadow-sm transition-opacity group-hover:opacity-100 group-focus-visible:opacity-100"
                    aria-hidden
                  />
                </Button>
              )}
        ...
        <div className="sticky top-20 space-y-4 self-start">
          ...
          >
            ...
            <Pencil
              className="absolute top-2 right-2 h-6 w-6 rounded-full border border-border bg-background p-1.5 text-muted-foreground opacity-30 shadow-sm transition-opacity group-hover:opacity-100 group-focus-visible:opacity-100"
              aria-hidden
            />
          </Button>
