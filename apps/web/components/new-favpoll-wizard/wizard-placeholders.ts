...
export const DEFAULT_GHOSTS: FieldGhosts = {
  ...
  note: "Guests see this only after they pledge. A quote, a memory, or a message.",
}
...
const GHOSTS_BY_CATEGORY: Record<string, FieldGhosts> = {
  memorial: {
    ...
    note: "e.g. Autumn, always. She said it felt like coming home.",
  },
  celebration: {
    ...
    note: "e.g. Mint choc chip is the best, of course.",
  },
  fundraiser: {
    ...
    note: "e.g. Thank you for your pledge — if we reach the goal, I'll eat the hat as well.",
  },
}
