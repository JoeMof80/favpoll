...
export const SCENES: HeroScene[] = [
  {
    ...
    poll: {
      id: "demo-poll-0",
      personal_reveal: "Mine was purple. I wore it to every occasion that mattered.",
      topic: {
        title: "Colour",
        topic_items: [
    ...
    charities: [{ id: "ch-mc", name: "Marie Curie", logo_url: null, registered_number: "207994" }],
    avatarColor: "#7F77DD",
    selectedIndex: 1,
    pledgeAmount: "£10",
  ...
  },
  {
    ...
    poll: {
      id: "demo-poll-1",
      personal_reveal: "Mint choc chip, of course. What do you mean you didn't know?",
      topic: {
        title: "Ice cream",
        topic_items: [
    ...
    charities: [{ id: "ch-gosh", name: "Great Ormond Street Hospital", logo_url: null, registered_number: "235825" }],
    avatarColor: "#E87D6A",
    selectedIndex: 15,
    pledgeAmount: "£20",
  ...
  },
  {
    ...
    poll: {
      id: "demo-poll-2",
      personal_reveal: "Autumn, always. Childhood memories of walking through leaves.",
      topic: {
        title: "Season",
        topic_items: [
    ...
    charities: [{ id: "ch-wt", name: "The Woodland Trust", logo_url: null, registered_number: "294344" }],
    avatarColor: "#4AAB8A",
    selectedIndex: 2,
    pledgeAmount: "£50",
  ...
  },
  {
    ...
    poll: {
      id: "demo-poll-3",
      personal_reveal: "The giant panda. They met at a conservation centre in Chengdu. Did you really need to ask?",
      topic: {
        title: "Animal",
        topic_items: [
    ...
    charities: [{ id: "ch-wwf", name: "WWF", logo_url: null, registered_number: "1081247" }],
    avatarColor: "#D4936B",
    selectedIndex: 4,
    pledgeAmount: "£20",
  ...
  },
  {
    ...
    poll: {
      id: "demo-poll-4",
      personal_reveal: "Bourbon. He kept a not-so-secret stash in his desk drawer.",
      topic: {
        title: "Biscuit",
        topic_items: [
    ...
    charities: [{ id: "ch-cr", name: "Comic Relief", logo_url: null, registered_number: "326568" }],
    avatarColor: "#534AB7",
    selectedIndex: 7,
    pledgeAmount: "£10",
    tagline: "We've had eight years of Dave's biscuit opinions. What about yours?",
    results: [
  ...
  },
  {
    ...
    poll: {
      ...
      topic: {
        ...
        topic_items: [
          ...
          { id: "f-et",         label: "E.T."                               },
          { id: "f-eternalsun", label: "Eternal Sunshine of the Spotless Mind" },
    ...
    charities: [{ id: "ch-pt", name: "The Prince's Trust", logo_url: null, registered_number: "1079675" }],
    avatarColor: "#5B9BD5",
    selectedIndex: 12,
    pledgeAmount: "£20",
    tagline: "James' favourite film was the reason he applied to study engineering — what's yours?",
    results: [
