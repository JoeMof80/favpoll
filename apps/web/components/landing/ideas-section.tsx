    ...
    >
      <div className="mx-auto w-full max-w-330 px-6 py-16">
        ...
        {/* The homepage's text-left / media-right row (see "The record" on
            ...
            than the page. */}
        {/* Back to 16/24 (founder, 2026-09-15: the #879 bump to 24 was
            "worse") — the crowding it chased was actually the topic
            picker OVERFLOWING its fixed frame over the next heading,
            fixed at the source in topic-picker-vignette. */}
