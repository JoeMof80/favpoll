...
// drawn with currentColor so they follow the theme like everything else.
const SOCIALS: { label: string; href: string; path: string }[] = [
  {
    label: "Instagram",
    href: "https://www.instagram.com/favpollapp",
    ...
    <footer data-site-chrome className="border-t border-border bg-background">
      <div className="mx-auto max-w-330 px-6 py-14">
        ...
        <div className="mt-12 flex flex-col gap-2 border-t border-border pt-6 text-xs text-muted-foreground sm:flex-row sm:items-center sm:justify-between">
          <p>© 2026 favpoll · a trading name of Josmo Services Ltd</p>
