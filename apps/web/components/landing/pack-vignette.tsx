...
// height — 794 x 1047px at 96dpi. SIX in a row with 24px gutters is
// 4884 x 1047, which the boxes below are that multiplied by the scale.
...
const SHEET_H = 1047
const GUTTER = 24
const SHEETS = ["a4", "a5", "a6", "tent", "place", "wallet"] as const
...
export function PackVignette() {
  return (
    <Vignette className="flex justify-center">
      ...
      <div
        data-artefact-box
        className="h-[63px] w-[293px] sm:h-[117px] sm:w-[542px] lg:h-[134px] lg:w-[621px]"
      >
        ...
        <div
          className="paper paper-screen flex origin-top-left scale-[0.06] gap-6 sm:scale-[0.111] lg:scale-[0.1273]"
