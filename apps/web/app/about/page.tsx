        ...
        <section className="relative bg-primary text-primary-foreground">
          ...
          <div className="relative mx-auto max-w-330 px-6 py-16 md:py-20">
            ...
            <p className="mt-6 max-w-xl text-lg leading-relaxed opacity-80">
              favpoll is a charitable polling platform for life's most
              significant moments. Guests pledge real money against their
              favourite things, in the name of someone being honoured. The
              rankings move in real time. The proceeds go to charity.
            </p>
          </div>
        </section>
            ...
            <FadeIn delay={0.08}>
              <div className="grid max-w-4xl gap-8 md:grid-cols-2">
                ...
                <p className="text-base leading-relaxed text-muted-foreground">
                  ...
                  retirements. Connect charitable giving with genuine
                  preference, and every answer costs someone something. Purple
                  sits in first place not because a thousand people clicked it
                  on a Thursday, but because families pledged real money in
                  memory of people who loved it.
                </p>
              </div>
            ...
            <div className="grid items-center gap-12 md:grid-cols-[1fr_auto]">
              <div>
                ...
                <div className="flex max-w-xl flex-col gap-5">
                  ...
                  <FadeIn delay={0.3}>
                    <p className="text-base leading-relaxed text-muted-foreground">
                      Most charitable platforms have charity without honour.
                      Most tributes have honour and love without charity.
                      favpoll has all three — that intersection is the point.
                    </p>
                  </FadeIn>
                </div>
              </div>
            ...
            <div className="flex max-w-3xl flex-col gap-12">
              <FadeIn>
                <section id="memorials" className="scroll-mt-20">
                  ...
                  <p className="mb-4 text-base leading-relaxed text-muted-foreground">
                    ...
                    colour, a favourite song — and holds their answer back.
                    Guests pledge to the family's chosen charity, and then read
                    it: their voice, one more time. At the service itself, a
                    live display can show the rankings shift as guests pledge
                    from their phones — a shared, living tribute no collection
                    tin could manage.
                  </p>
                  <div
                    id="wills"
                  ...
                  >
                    ...
                    <p className="text-base leading-relaxed text-muted-foreground">
                      Some favpolls are written by the person themselves and
                      kept in a will or letter of wishes — the questions and the
                      reveals prepared in advance, in their own words. An
                      executor creates the favpoll when the time comes. It is
                      not morbid; it is generous. It says: here is something I
                      want you to know about me, and here is how I want you to
                      be remembered knowing it.
                    </p>
                  </div>
                </section>
              </FadeIn>
              ...
              <FadeIn>
                <section id="fundraisers" className="scroll-mt-20">
                  ...
                  <p className="text-base leading-relaxed text-muted-foreground">
                    A favpoll doesn't have to honour one person. A cause can
                    carry one — a village hall roof, a community appeal, a
                    memorial fund. The poll gives people a reason to gather
                    round, the reveal gives them something back, and every
                    pledge goes where it was promised.
                  </p>
                </section>
              </FadeIn>
            </div>
          ...
          >
            <FadeIn>
              ...
              <p className="max-w-2xl text-base leading-relaxed text-muted-foreground">
                ...
                Stripe. You choose up to three charities per favpoll — the
                pledged total is split equally between them — and the fee is
                always shown to guests before they confirm.
              </p>
            </FadeIn>
          </section>
          ...
          <section className="border-b border-border py-16">
            <FadeIn>
              ...
              <p className="max-w-2xl text-base leading-relaxed text-muted-foreground">
                ...
                of human favourites, built entirely through acts of generosity.
                It wasn't gamed, and it wasn't passively accumulated. It was
                paid for, freely, by people honouring someone they loved.
              </p>
              <p className="mt-6">
