...
import type { FavpollWithDetails } from "@favpoll/types"
  ...
  return (
    <main className="mx-auto max-w-2xl px-4 pt-10 pb-16">
      <div className="flex items-center gap-3 text-sm text-muted-foreground">
        <Link href="/favpolls" className="hover:text-foreground">
          Your favpolls
        </Link>
        ...
        <div className="flex gap-2">
          <code className="flex-1 truncate rounded-md border border-border bg-muted/30 px-3 py-2 font-mono text-sm text-foreground">
            {typeof window !== "undefined"
              ? `${window.location.origin}/favpolls/${id}`
              : `/favpolls/${id}`}
          </code>
        </div>
